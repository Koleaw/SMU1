...
`font-display: optional` and the existing asynchronous stylesheet activation are preserved. Body, heading and action weights (400/600/700) are preloaded; weight 500 loads when used. URLs are relative to this stylesheet so both root-domain and repository-base deployments work.
