...
export const contentSchemas = {
  'product-sections': z.object({
    ...
    seoDescription: z.string(), pageBlocks: z.array(pageBlockSchema).optional()
  }).strict(),
  ...
  products: z.object({
    ...
    imageView: imageViewSchema.optional(), gallery: z.array(z.string()).optional(), placeholderLabel: z.string(),
  ...
  projects: z.object({
    ...
    year: z.number().optional(), seoTitle: z.string(), seoDescription: z.string()
  }).strict(),
  jobs: z.object({
  ...
  'static-pages': z.object({
    ...
    heroPrimaryLabel: z.string().optional(), heroSecondaryLabel: z.string().optional(), heroMediaVideo: z.string().optional(),
    ...
    contactDescription: z.string().optional(), pageBlocks: z.array(pageBlockSchema).optional()
  }).strict()
};
