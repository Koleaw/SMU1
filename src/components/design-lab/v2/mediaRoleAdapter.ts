...
// Temporary, explicit V2-only presentation choices. The project records, schemas and media stay untouched.
// These choices are intended to become editable presentation fields in a future CMS iteration.
...
export const getV2ProjectPresentation = (project: V2ProjectRecord): V2ProjectPresentation => {
  ...
  const publicGallery = configuredGallery
    ? configuredGallery
